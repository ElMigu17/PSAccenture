...
import {
  ...
  _warn,
  createGrid
} from "./chunk-PLBDETOG.js";
import "./chunk-HKJ2B2AA.js";

// node_modules/ag-grid-vue3/dist/main.mjs
var V = Object.defineProperty;
var W = (l, d, e) => d in l ? V(l, d, { enumerable: true, configurable: true, writable: true, value: e }) : l[d] = e;
...
var v = class _v {
  ...
  static createAndMountComponent(d, e, n, a) {
    const t = _v.getComponentDefinition(d, n);
    if (!t)
      return;
  ...
  static mount(d, e, n, a) {
    ...
    return render(t, u), { vNode: t, destroy: () => {
      u && render(null, u), u = null, t = null;
    }, el: u };
  }
  static searchForComponentInstance(d, e, n = 10, a = false) {
    ...
    return !t && !a ? (_error(114, { component: e }), null) : t;
  }
};
var ce = class extends BaseComponentWrapper {
  constructor(e, n) {
    super();
    y(this, "parent");
    y(this, "provides");
  ...
  createWrapper(e) {
    ...
    class a extends fe {
      ...
      hasMethod(o) {
        ...
        return i[o] ? true : ((p = i.$.exposed) == null ? void 0 : p[o]) != null || ((c = i.exposed) == null ? void 0 : c[o]) != null || i.$.setupState[o] != null;
      }
      callMethod(o, i) {
        var R, w;
  ...
  createMethodProxy(e, n, a) {
    return function() {
      return e.hasMethod(n) ? e.callMethod(n, arguments) : (a && _warn(233, { methodName: n }), null);
    };
  }
  destroy() {
    this.parent = null;
...
var ge = class extends VanillaFrameworkOverrides {
  ...
  frameworkComponent(e, n) {
    let a = v.searchForComponentInstance(this.parent, e, 10, true) ? e : null;
    if (!a && n && n[e]) {
      const t = n[e];
      a = v.searchForComponentInstance(this.parent, t, 10, true) ? t : null;
    }
    return a;
  }
...
function h(l) {
  const d = (e) => Array.isArray(e) ? e.map((n) => d(n)) : isRef(e) || isReactive(e) || isProxy(e) ? d(toRaw(e)) : e && typeof e == "object" && Object.keys(e).length > 0 ? Object.keys(e).reduce((n, a) => (n[a] = me(e[a]) ? e[a] : d(e[a]), n), {}) : e;
  return d(l);
}
var he = { ref: "root" };
var Se = defineComponent({
  ...
  setup(l, { expose: d, emit: e }) {
    const n = l, a = useTemplateRef("root"), t = ref(void 0), u = ref(false), o = ref(false), i = ref(false), p = ref({}), c = ref(null), R = toRefs(n);
    _ALL_GRID_OPTIONS.filter((r) => r != "gridOptions").forEach((r) => {
      watch(
        () => R[r],
        (s, f) => {
          D(r, s);
    ...
    const w = /* @__PURE__ */ new Set(["rowDataUpdated", "cellValueChanged", "rowValueChanged"]), m = useModel(l, "modelValue"), S = ref(false), A = e;
    watch(
      m,
      (r, s) => {
        u.value && (S.value = true, D("rowData", h(r), h(s)));
      },
      { deep: true }
    );
    const k = Ce(() => {
      ...
      if (o.value)
        return;
      s === "gridReady" && (i.value = true);
      const f = ALWAYS_SYNC_GLOBAL_EVENTS.has(s);
      f && !r || !f && r || w.has(s) && (S.value || H(s), S.value = false);
    }, D = (r, s, f) => {
      if (u.value) {
        let g = s.value || s;
    ...
    return onMounted(() => {
      ...
      const r = new ce(getCurrentInstance(), I()), s = {
        globalListener: F(),
        ...
        _combineAttributesAndGridOptions(h(n.gridOptions), n, [
          ..._ALL_GRID_OPTIONS,
          ..._ALL_EVENTS.map((L) => _getCallbackForEvent(L))
        ])
      ), g = G();
      g !== void 0 && (f.rowData = h(g)), t.value = createGrid(a.value, f, s), u.value = true;
    }), onUnmounted(() => {
      var r;
      u.value && ((r = t == null ? void 0 : t.value) == null || r.destroy(), o.value = true);
    }), d({
      api: t
    }), (r, s) => (openBlock(), createElementBlock("div", he, null, 512));
  }
});
export {
  Se as AgGridVue
