...
var W = (l, d, e) => d in l ? V(l, d, { enumerable: !0, configurable: !0, writable: !0, value: e }) : l[d] = e;
var y = (l, d, e) => W(l, typeof d != "symbol" ? d + "" : d, e);
import { defineComponent as M, createVNode as z, render as b, isRef as N, isReactive as U, isProxy as _, toRaw as j, mergeModels as P, mergeDefaults as q, useTemplateRef as $, ref as C, toRefs as K, watch as T, useModel as Q, onMounted as Y, getCurrentInstance as B, markRaw as J, onUnmounted as X, openBlock as Z, createElementBlock as ee } from "vue";
import { _error as x, BaseComponentWrapper as ne, _warn as oe, VanillaFrameworkOverrides as de, _ALL_GRID_OPTIONS as O, _processOnChange as te, ModuleRegistry as ie, RowApiModule as re, _combineAttributesAndGridOptions as ae, _ALL_EVENTS as le, _getCallbackForEvent as ue, createGrid as se, ALWAYS_SYNC_GLOBAL_EVENTS as pe } from "ag-grid-community";
class v {
  static getComponentDefinition(d, e) {
    let n;
    return typeof d == "string" ? n = this.searchForComponentInstance(e, d) : n = { extends: M({ ...d }) }, n || x(114, { component: d }), n.extends ? (n.extends.setup && (n.setup = n.extends.setup), n.extends.props = this.addParamsToProps(n.extends.props)) : n.props = this.addParamsToProps(n.props), n;
  }
  ...
  static createAndMountComponent(d, e, n, a) {
    const t = v.getComponentDefinition(d, n);
    if (!t)
      return;
    const { vNode: u, destroy: o, el: i } = this.mount(
      t,
  ...
  static mount(d, e, n, a) {
    let t = z(d, e);
    t.appContext = { ...n.appContext, provides: a };
    let u = document.createElement("div");
    return b(t, u), { vNode: t, destroy: () => {
      u && b(null, u), u = null, t = null;
    }, el: u };
  }
  static searchForComponentInstance(d, e, n = 10, a = !1) {
    let t = null, u = 0, o = d.parent;
    for (; !t && o && o.components && ++u < n; )
      o.components && o.components[e] && (t = o.components[e]), o = o.parent;
    for (u = 0, o = d.parent; !t && o && o.$options && ++u < n; ) {
      const i = o;
      i.$options && i.$options.components && i.$options.components[e] ? t = i.$options.components[e] : i[e] && (t = i[e]), o = o.parent;
    }
    for (u = 0, o = d.parent; !t && o && ++u < n; ) {
      if (o.exposed) {
        const i = o;
    ...
    return !t && !a ? (x(114, { component: e }), null) : t;
  }
}
class ce extends ne {
  constructor(e, n) {
  ...
  createWrapper(e) {
    ...
    class a extends fe {
      ...
      callMethod(o, i) {
        ...
        {
          const m = ((R = p.$.exposed) == null ? void 0 : R[o]) || ((w = p.exposed) == null ? void 0 : w[o]) || p.$.setupState[o];
  ...
  createMethodProxy(e, n, a) {
    return function() {
      return e.hasMethod(n) ? e.callMethod(n, arguments) : (a && oe(233, { methodName: n }), null);
    };
  }
  destroy() {
    this.parent = null;
...
class fe {
  ...
  init(d) {
    const { componentInstance: e, element: n, destroy: a } = this.createComponent(d);
    this.componentInstance = e, this.unmount = a, this.element = n.firstElementChild ?? n;
  }
}
class ge extends de {
  constructor(e) {
  ...
  frameworkComponent(e, n) {
    let a = v.searchForComponentInstance(this.parent, e, 10, !0) ? e : null;
    if (!a && n && n[e]) {
      const t = n[e];
      a = v.searchForComponentInstance(this.parent, t, 10, !0) ? t : null;
    }
    return a;
  }
...
function h(l) {
  const d = (e) => Array.isArray(e) ? e.map((n) => d(n)) : N(e) || U(e) || _(e) ? d(j(e)) : e && typeof e == "object" && Object.keys(e).length > 0 ? Object.keys(e).reduce((n, a) => (n[a] = me(e[a]) ? e[a] : d(e[a]), n), {}) : e;
  return d(l);
}
const he = { ref: "root" }, Se = /* @__PURE__ */ M({
  __name: "AgGridVue",
  ...
  setup(l, { expose: d, emit: e }) {
    const n = l, a = $("root"), t = C(void 0), u = C(!1), o = C(!1), i = C(!1), p = C({}), c = C(null), R = K(n);
    O.filter((r) => r != "gridOptions").forEach((r) => {
      T(
        () => R[r],
        (s, f) => {
          D(r, s);
    ...
    const w = /* @__PURE__ */ new Set(["rowDataUpdated", "cellValueChanged", "rowValueChanged"]), m = Q(l, "modelValue"), S = C(!1), A = e;
    T(
      m,
      (r, s) => {
        u.value && (S.value = !0, D("rowData", h(r), h(s)));
      },
      { deep: !0 }
    );
    const k = Ce(() => {
      ...
      i.value && w.has(r) && k();
    }, G = () => m.value || n.rowData || n.gridOptions.rowData, E = () => {
      const r = [];
      return t == null || t.value.forEachNode((s) => {
        r.push(s.data);
      }), r;
    }, F = (r) => (s) => {
      if (o.value)
        return;
      s === "gridReady" && (i.value = !0);
      const f = pe.has(s);
      f && !r || !f && r || w.has(s) && (S.value || H(s), S.value = !1);
    }, D = (r, s, f) => {
      if (u.value) {
        let g = s.value || s;
        r === "rowData" && g != null && (g = h(g)), p.value[r] = g, c.value == null && (c.value = window.setTimeout(() => {
          c.value = null, te(p.value, t.value), p.value = {};
        }, 0));
      }
    }, I = () => Object.create(B().provides);
    return Y(() => {
      ie.registerModules([re]);
      const r = new ce(B(), I()), s = {
        globalListener: F(),
        globalSyncListener: F(!0),
        frameworkOverrides: new ge(B()),
        providedBeanInstances: {
          frameworkCompWrapper: r
        },
        modules: n.modules
      }, f = J(
        ae(h(n.gridOptions), n, [
          ...O,
          ...le.map((L) => ue(L))
        ])
      ), g = G();
      g !== void 0 && (f.rowData = h(g)), t.value = se(a.value, f, s), u.value = !0;
    }), X(() => {
      var r;
      u.value && ((r = t == null ? void 0 : t.value) == null || r.destroy(), o.value = !0);
    }), d({
      api: t
    }), (r, s) => (Z(), ee("div", he, null, 512));
  }
});
export {
  Se as AgGridVue
